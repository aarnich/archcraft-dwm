...
static const char *termcmd[] = {"/usr/share/archcraft/dwm/bin/dwmterm.sh",
                                NULL};
static const char *floatterm[] = {"/usr/share/archcraft/dwm/bin/dwmterm.sh",
                                  "-f", NULL};
static const char *fmcmd[] = {"/usr/share/archcraft/dwm/bin/dwmapps.sh", "-f",
                              NULL};
static const char *editcmd[] = {"/usr/share/archcraft/dwm/bin/dwmapps.sh", "-e",
                                NULL};
static const char *webcmd[] = {"/usr/share/archcraft/dwm/bin/dwmapps.sh", "-w",
                               NULL};

/* Rofi Menus */
static const char *rofi_cmd[] = {"/usr/share/archcraft/dwm/rofi/bin/launcher",
                                 NULL};
static const char *rofi_rootcmd[] = {"/usr/share/archcraft/dwm/rofi/bin/asroot",
                                     NULL};
static const char *rofi_layoutcmd[] = {
    "/usr/share/archcraft/dwm/rofi/bin/layouts", NULL};
static const char *rofi_mpdcmd[] = {"/usr/share/archcraft/dwm/rofi/bin/mpd",
                                    NULL};
static const char *rofi_nmcmd[] = {
    "/usr/share/archcraft/dwm/rofi/bin/network_menu", NULL};
static const char *rofi_powercmd[] = {
    "/usr/share/archcraft/dwm/rofi/bin/powermenu", NULL};
static const char *rofi_shotcmd[] = {
    "/usr/share/archcraft/dwm/rofi/bin/screenshot", NULL};
static const char *rofi_wincmd[] = {"/usr/share/archcraft/dwm/rofi/bin/windows",
                                    NULL};

/* Misc */
static const char *cpickcmd[] = {"color-gpick", NULL};
static const char *lockcmd[] = {"/usr/share/archcraft/dwm/bin/dwmlock.sh",
                                NULL};
static const char *layoutswitcher[] = {
    "/usr/share/archcraft/dwm/bin/layoutmenu.sh", NULL};
...
static Key keys[] = {
    ...
    {ALTKEY | ControlMask, XK_P, spawn, {.v = shotarea}},
    ...
    // Cycle between tags ---------
    {MODKEY | ShiftMask, XK_Right, shiftviewclients, {.i = +1}},
    {MODKEY | ShiftMask, XK_Left, shiftviewclients, {.i = -1}},
    ...
    {MODKEY | ControlMask, XK_Left, movestack, {.i = +1}}, // Switch master
    ...
    // { MODKEY|ControlMask, 		XK_Left, 					setmfact, {.f = -0.05} }, // Shrink
    // left { MODKEY|ControlMask, 		XK_Right,
    // setmfact, {.f = +0.05} }, // Shrink right
